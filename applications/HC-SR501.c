...
int HCSR501_part_init(void)
{
	...
	hcsr_mq = rt_mq_create("hcsr_mq",32,2,RT_IPC_FLAG_FIFO);
    if(hcsr_mq == RT_NULL)
    {
    ...
    hcs_timer = rt_timer_create("HCSR501_timer",HCSR501_timer_callback,RT_NULL,1000,RT_TIMER_FLAG_PERIODIC);
